    ...
    <Box component="main" sx={{ gridArea: 'content', overflow: 'auto', p: 0.5 }}>
      ...
      <Container maxWidth="xl" disableGutters sx={{ px: 0.5 }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            ...
            <Box>
              ...
              <Box sx={{ border: `1px solid ${renk.cizgi}`, borderTop: 'none', backgroundColor: renk.yuzey, p: 1.75 }}>
                ...
                <VeriTablosu
                      ...
                      sutunlar={[
                        { anahtar: 'us97', baslik: 'US97 Kodu', genislik: 120,
                          bicim: (_, u) => u.u97Kodu || u.us97Kodu || u.naceKodu || '-' },
                ...
                {(aktifBolum === 'yerli' || aktifBolum === 'ithal') && (
                  <Box sx={{ py: 4, textAlign: 'center' }}>
                    ...
                    <Button variant="contained" onClick={() => navigate('/tesvik/makine-yonetimi')}>
                      Makine Listesini Aç
                    </Button>
                  </Box>
                )}
          ...
          {tesvik?._id && <KdvMuafiyetYazisi tesvikModel="Tesvik" tesvikId={tesvik._id} />}
        </Box>
      </Container>

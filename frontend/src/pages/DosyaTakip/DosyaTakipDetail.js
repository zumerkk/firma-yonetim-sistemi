...
const DOSYA_TURLERI = ['ETUYS Talep Görüntüsü', 'ETUYS Eksik Görüntüsü', 'ETUYS Sonuç Görüntüsü', 'Görüşme Sırası Talep Dosyaları', 'Eksik Tamamlama Evrakları'];
...
const DosyaTakipDetail = () => {
    ...
    // müşteri: "Kurum Eksik Detayı" alt-formu (Firma Yetkilisi / Sorumlu Personel /
    // Beklenen Eksikler / Gelen Belgeler) tüm eksik durumlarından kaldırıldı.
    // Mevcut kayıtların verisi modelde duruyor ve "Eksiği Tamamla" aktarımında
    // belge ekine yazılmaya devam ediyor; sadece giriş arayüzü yok.

...
const TesvikImport = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const result = await yeniTesvikService.confirmImport(importSessionId);
      if (result.success) {
                      ...
                      <TableRow key={i}>
                        ...
                        <TableCell align="center">
                          <IconButton
                            size="small"
                            color="primary"
                            onClick={() => navigate(`/yeni-tesvik/${rec.tesvikId}`)}
                          >

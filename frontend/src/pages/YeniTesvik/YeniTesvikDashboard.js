// 🆕 YENİ TEŞVİK PANELİ — ETUYS diline geçirildi (madde 6 / Faz 3)
//
...
//
// ⚠️ Bu dosya Tesvik/TesvikDashboard.js ile satır satır aynı; tek fark uç nokta
        ...
        <Container maxWidth="xl" sx={{ px: '0 !important' }}>
          <Box sx={{ mb: `${aralik.grup}px` }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              <DurumRozeti durum="onay" metin="Yalnızca Yeni Kayıtlar" />
            </Box>
            ...
            {/* Sistem geçişi — eskiden yeşil dolgulu/mor kenarlıklı düğme çiftiydi */}
            <Box sx={{ mt: 0.8, display: 'flex', gap: 0.8 }}>
              <Button variant="contained" size="small" disabled>Yeni Sistem</Button>
          ...
          <Grid container spacing={1.2} sx={{ mb: `${aralik.grup}px` }}>
            <Grid item xs={12} sm={6} md={3}>
              <SayiKutusu
                ...
                yukleniyor={loading} onTik={() => navigate('/yeni-tesvik/liste')}
              />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <SayiKutusu
            ...
            <Grid item xs={12} lg={8}>
              ...
              >
                <VeriTablosu
                  ...
                  onSatirTik={(satir) => navigate(`/yeni-tesvik/${satir._id}`)}
